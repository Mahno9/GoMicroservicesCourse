...
// ListParts provides a mock function with given fields: ctx, in
func (_m *InventoryClient) ListParts(ctx context.Context, in *model.PartsFilter) ([]*model.Part, error) {
...
//   - ctx context.Context
//   - in *model.PartsFilter
func (_e *InventoryClient_Expecter) ListParts(ctx interface{}, in interface{}) *InventoryClient_ListParts_Call {
	return &InventoryClient_ListParts_Call{Call: _e.mock.On("ListParts", ctx, in)}
}

func (_c *InventoryClient_ListParts_Call) Run(run func(ctx context.Context, in *model.PartsFilter)) *InventoryClient_ListParts_Call {
