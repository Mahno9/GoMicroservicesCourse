...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\x04WING\x10\x042\xac\x01\n" +
	"\x10InventoryService\x12H\n" +
	"\aGetPart\x12\x1c.inventory.v1.GetPartRequest\x1a\x1d.inventory.v1.GetPartResponse\"\x00\x12N\n" +
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponse\"\x00BUZShttps://github.com/Mahno9/GoMicroservicesCourse/pkg/progo/inventory/v1;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	8,  // 5: inventory.v1.Part.dimensions:type_name -> inventory.v1.Dimensions
	7,  // 6: inventory.v1.Part.manufacturer:type_name -> inventory.v1.Manufacturer
