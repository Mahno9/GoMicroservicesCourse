...
// Kafka message from Order service
...
func (x *OrderPaid) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
// Kafka message from Assemble service
...
const file_events_v1_events_proto_rawDesc = "" +
	"\n" +
	"\x16events/v1/events.proto\x12\tevents.v1\"\xad\x01\n" +
	"\tOrderPaid\x12\x12\n" +
	...
	"order_uuid\x18\x02 \x01(\tR\torderUuid\x12\x1b\n" +
	"\tuser_uuid\x18\x03 \x01(\tR\buserUuid\x12$\n" +
	"\x0ebuild_time_sec\x18\x04 \x01(\x03R\fbuildTimeSecBOZMhttps://github.com/Mahno9/GoMicroservicesCourse/pkg/progo/events/v1;events_v1b\x06proto3"
