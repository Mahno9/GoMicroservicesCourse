...
func (_c *MongoDatabase_Collection_Call) Return(_a0 repository.MongoCollection) *MongoDatabase_Collection_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MongoDatabase_Collection_Call) RunAndReturn(run func(string, ...*options.CollectionOptions) repository.MongoCollection) *MongoDatabase_Collection_Call {
	_c.Call.Return(run)
	return _c
}
